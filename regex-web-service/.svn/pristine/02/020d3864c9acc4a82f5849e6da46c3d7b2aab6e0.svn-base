...
public interface EvaluationOneService{
	/**
	 ...
	 * @return
	 */
    int updateEvaluationOneDTO(EvaluationOneDTO value,  Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyEvaluationOneDTO(EvaluationOneDTO value, Assist assist);
}