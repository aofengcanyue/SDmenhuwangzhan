...
public interface EvaluationResultService{
	 ...
	 * @return
	 */
    int updateEvaluationResultDTO(EvaluationResultDTO value,  Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyEvaluationResultDTO(EvaluationResultDTO value, Assist assist);
}