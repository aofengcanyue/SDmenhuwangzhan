...
public interface EvaluationThreeService{
	/**
	 ...
	 * @return
	 */
    int updateEvaluationThreeDTO(EvaluationThreeDTO value,  Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyEvaluationThreeDTO(EvaluationThreeDTO value, Assist assist);
}