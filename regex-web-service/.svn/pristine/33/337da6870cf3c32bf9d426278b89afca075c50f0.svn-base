...
public interface EvaluationTwoDAO{
	/**
	...
	/**
	 * 批量插入EvaluationTwoDTO到数据库,包括null值
	 * @param value
	 * @return
	 */
	 ...
	 * @return
	 */
    int updateEvaluationTwoDTO(@Param("enti") EvaluationTwoDTO value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyEvaluationTwoDTO(@Param("enti") EvaluationTwoDTO value, @Param("assist") Assist assist);
}