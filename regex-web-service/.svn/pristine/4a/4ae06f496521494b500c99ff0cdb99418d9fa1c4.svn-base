...
public interface SysRoleFhbuttonDao{
	/**
	...
	/**
	 * 批量插入SysRoleFhbutton到数据库,包括null值
	 * @param value
	 * @return
	 */
	 ...
	 * @return
	 */
    int updateSysRoleFhbutton(@Param("enti") SysRoleFhbutton value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptySysRoleFhbutton(@Param("enti") SysRoleFhbutton value, @Param("assist") Assist assist);
}