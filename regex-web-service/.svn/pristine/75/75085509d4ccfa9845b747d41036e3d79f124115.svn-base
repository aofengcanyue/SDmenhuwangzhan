...
public interface CommonAccordEvaluateDAO{
	/**
	...
	/**
	 * 批量插入CommonAccordEvaluateDTO到数据库,包括null值
	 * @param value
	 * @return
	 */
	 ...
	 * @return
	 */
    int updateCommonAccordEvaluateDTO(@Param("enti") CommonAccordEvaluateDTO value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyCommonAccordEvaluateDTO(@Param("enti") CommonAccordEvaluateDTO value, @Param("assist") Assist assist);
}