...
public interface ParkAccordDAO{
	/**
	 ...
	 * @return
	 */
    int updateParkAccordDTO(@Param("enti") ParkAccordDTO value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyParkAccordDTO(@Param("enti") ParkAccordDTO value, @Param("assist") Assist assist);
}