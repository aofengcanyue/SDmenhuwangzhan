...
public interface IWaterDAO {
     ...
     * @return
     */
    int updateWaterDTO(@Param("enti") WaterDTO value, @Param("assist") Assist assist);
    /**
     ...
     * @return
     */
    int updateNonEmptyWaterDTO(@Param("enti") WaterDTO value, @Param("assist") Assist assist);
}
