...
public interface GreenSupplyChainEvaluationDAO{
	/**
	...
	/**
	 * 批量插入GreenSupplyChainEvaluation到数据库,包括null值
	 * @param value
	 * @return
	 */
	 ...
	 * @return
	 */
    int updateGreenSupplyChainEvaluation(@Param("enti") GreenSupplyChainEvaluation value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyGreenSupplyChainEvaluation(@Param("enti") GreenSupplyChainEvaluation value, @Param("assist") Assist assist);
}