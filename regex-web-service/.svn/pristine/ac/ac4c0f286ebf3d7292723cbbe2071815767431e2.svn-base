...
public interface AchievementDAO{
	 ...
	 * @return
	 */
    int updateAchievementDTO(@Param("enti") AchievementDTO value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyAchievementDTO(@Param("enti") AchievementDTO value, @Param("assist") Assist assist);
}