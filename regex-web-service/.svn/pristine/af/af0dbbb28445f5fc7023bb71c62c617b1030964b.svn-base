...
public interface GreenSupply1Service{
	/**
	 ...
	 * @return
	 */
    int updateGreenSupply1DTO(GreenSupply1DTO value,  Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyGreenSupply1DTO(GreenSupply1DTO value, Assist assist);
}