...
public interface ExpertAnswerDAO{
	 ...
	 * @return
	 */
    int updateExpertAnswerDTO(@Param("enti") ExpertAnswerDTO value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyExpertAnswerDTO(@Param("enti") ExpertAnswerDTO value, @Param("assist") Assist assist);
}