...
public interface EvaluationFiveDAO{
	/**
	...
	/**
	 * 批量插入EvaluationFiveDTO到数据库,包括null值
	 * @param value
	 * @return
	 */
	 ...
	 * @return
	 */
    int updateEvaluationFiveDTO(@Param("enti") EvaluationFiveDTO value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyEvaluationFiveDTO(@Param("enti") EvaluationFiveDTO value, @Param("assist") Assist assist);
}