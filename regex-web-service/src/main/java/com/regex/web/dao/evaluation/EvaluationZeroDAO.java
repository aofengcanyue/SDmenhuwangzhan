...
public interface EvaluationZeroDAO{
	/**
	...
	/**
	 * 批量插入EvaluationZeroDTO到数据库,包括null值
	 * @param value
	 * @return
	 */
	 ...
	 * @return
	 */
    int updateEvaluationZeroDTO(@Param("enti") EvaluationZeroDTO value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyEvaluationZeroDTO(@Param("enti") EvaluationZeroDTO value, @Param("assist") Assist assist);
}