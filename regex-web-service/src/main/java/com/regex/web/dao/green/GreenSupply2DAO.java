...
public interface GreenSupply2DAO{
	/**
	...
	/**
	 * 批量插入GreenSupply2DTO到数据库,包括null值
	 * @param value
	 * @return
	 */
	 ...
	 * @return
	 */
    int updateGreenSupply2DTO(@Param("enti") GreenSupply2DTO value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyGreenSupply2DTO(@Param("enti") GreenSupply2DTO value, @Param("assist") Assist assist);
}