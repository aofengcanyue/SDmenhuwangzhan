...
public interface ParkAssessmentDAO{
	/**
	...
	/**
	 * 批量插入ParkAssessmentDTO到数据库,包括null值
	 * @param value
	 * @return
	 */
	 ...
	 * @return
	 */
    int updateParkAssessmentDTO(@Param("enti") ParkAssessmentDTO value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyParkAssessmentDTO(@Param("enti") ParkAssessmentDTO value, @Param("assist") Assist assist);
}