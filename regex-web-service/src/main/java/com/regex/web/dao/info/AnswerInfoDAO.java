...
public interface AnswerInfoDAO{
	 ...
	 * @return
	 */
    int updateAnswerInfoDTO(@Param("enti") AnswerInfoDTO value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyAnswerInfoDTO(@Param("enti") AnswerInfoDTO value, @Param("assist") Assist assist);
}