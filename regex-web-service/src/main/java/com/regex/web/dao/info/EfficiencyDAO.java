...
public interface EfficiencyDAO{
	 ...
	 * @return
	 */
    int updateEfficiencyDTO(@Param("enti") EfficiencyDTO value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyEfficiencyDTO(@Param("enti") EfficiencyDTO value, @Param("assist") Assist assist);
}