...
public interface IEliminationDAO {
    ...
    /**
     * 批量插入EliminationDTO到数据库,包括null值
     * @param value
     * @return
     */
     ...
     * @return
     */
    int updateEliminationDTO(@Param("enti") EliminationDTO value, @Param("assist") Assist assist);
    /**
     ...
     * @return
     */
    int updateNonEmptyEliminationDTO(@Param("enti") EliminationDTO value, @Param("assist") Assist assist);
}
