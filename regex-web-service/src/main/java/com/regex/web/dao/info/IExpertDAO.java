...
public interface IExpertDAO{
	 ...
	 * @return
	 */
    int updateExpertDTO(@Param("enti") ExpertDTO value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyExpertDTO(@Param("enti") ExpertDTO value, @Param("assist") Assist assist);
}