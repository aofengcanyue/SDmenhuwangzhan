...
public interface IndustryInfoDAO{
	...
	/**
	 * 批量插入IndustryInfoDTO到数据库,包括null值
	 * @param value
	 * @return
	 */
	 ...
	 * @return
	 */
    int updateIndustryInfoDTO(@Param("enti") IndustryInfoDTO value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyIndustryInfoDTO(@Param("enti") IndustryInfoDTO value, @Param("assist") Assist assist);
}