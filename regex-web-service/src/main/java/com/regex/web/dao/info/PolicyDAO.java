...
public interface PolicyDAO{
	 ...
	 * @return
	 */
    int updatePolicyDTO(@Param("enti") PolicyDTO value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyPolicyDTO(@Param("enti") PolicyDTO value, @Param("assist") Assist assist);
}