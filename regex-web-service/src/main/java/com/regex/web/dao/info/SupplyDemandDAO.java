...
public interface SupplyDemandDAO{
	...
	/**
	 * 批量插入SupplyDemandDTO到数据库,包括null值
	 * @param value
	 * @return
	 */
	 ...
	 * @return
	 */
    int updateSupplyDemandDTO(@Param("enti") SupplyDemandDTO value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptySupplyDemandDTO(@Param("enti") SupplyDemandDTO value, @Param("assist") Assist assist);
}