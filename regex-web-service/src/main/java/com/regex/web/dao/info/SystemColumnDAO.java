...
public interface SystemColumnDAO{
	/**
	 ...
	 * @return
	 */
    int updateSystemColumnDTO(@Param("enti") SystemColumnDTO value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptySystemColumnDTO(@Param("enti") SystemColumnDTO value, @Param("assist") Assist assist);
}