...
public interface SysFhbuttonDao{
	/**
	 ...
	 * @return
	 */
    int updateSysFhbutton(@Param("enti") SysFhbutton value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptySysFhbutton(@Param("enti") SysFhbutton value, @Param("assist") Assist assist);
}