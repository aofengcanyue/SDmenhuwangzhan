...
public interface EvaluationFourService{
	/**
	 ...
	 * @return
	 */
    int updateEvaluationFourDTO(EvaluationFourDTO value,  Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyEvaluationFourDTO(EvaluationFourDTO value, Assist assist);
}