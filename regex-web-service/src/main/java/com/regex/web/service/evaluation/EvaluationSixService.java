...
public interface EvaluationSixService{
	/**
	 ...
	 * @return
	 */
    int updateEvaluationSixDTO(EvaluationSixDTO value,  Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyEvaluationSixDTO(EvaluationSixDTO value, Assist assist);
}