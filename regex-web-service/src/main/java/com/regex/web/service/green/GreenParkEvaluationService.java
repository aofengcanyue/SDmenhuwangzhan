...
public interface GreenParkEvaluationService{
	/**
	...
	/**
	 * 批量插入GreenParkEvaluationDTO到数据库
	 * @param value
	 * @return
	 */
	 ...
	 * @return
	 */
    int updateGreenParkEvaluationDTO(GreenParkEvaluationDTO value,  Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyGreenParkEvaluationDTO(GreenParkEvaluationDTO value, Assist assist);
}