...
public interface GreenParkService{
	/**
	 ...
	 * @return
	 */
    int updateGreenParkDTO(GreenParkDTO value,  Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyGreenParkDTO(GreenParkDTO value, Assist assist);
}