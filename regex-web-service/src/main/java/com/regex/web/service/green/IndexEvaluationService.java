...
public interface IndexEvaluationService{
	/**
	 ...
	 * @return
	 */
    int updateIndexEvaluationDTO(IndexEvaluationDTO value,  Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyIndexEvaluationDTO(IndexEvaluationDTO value, Assist assist);
}