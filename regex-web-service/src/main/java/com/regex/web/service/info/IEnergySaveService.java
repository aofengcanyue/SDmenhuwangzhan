...
public interface IEnergySaveService {
     ...
     * @return
     */
    int updateEnergySaveDTO(EnergySaveDTO value,  Assist assist);
    /**
     ...
     * @return
     */
    int updateNonEmptyEnergySaveDTO(EnergySaveDTO value, Assist assist);
}
