...
public interface SupplyEvaluationResultService{
	/**
	...
	/**
	 * 批量插入SupplyEvaluationResultDTO到数据库
	 * @param value
	 * @return
	 */
	 ...
	 * @return
	 */
    int updateSupplyEvaluationResultDTO(SupplyEvaluationResultDTO value,  Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptySupplyEvaluationResultDTO(SupplyEvaluationResultDTO value, Assist assist);
}