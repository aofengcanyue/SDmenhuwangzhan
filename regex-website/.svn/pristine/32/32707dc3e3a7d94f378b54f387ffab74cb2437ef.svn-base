...
public class EnergySaveController {
    ...
    public String show(Model model,@ModelAttribute("params")QueryConditions params) {
        ...
        for(EnergySaveDTO energySaveDTO : energySaveList) {
            
            String technical = energySaveDTO.getTechnical().replaceAll(params.getName(), "<b class='search_i'>"+params.getName() +"</b>");
            energySaveDTO.setTechnical(technical);
